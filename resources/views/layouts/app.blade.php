            ...
            <div class="header-content-wrapper">
                <div class="header-content d-flex justify-content-between align-items-center">
                    <div class="header-left-content d-flex">
                        ...
                        <div class="main-logo">
                            <a href="index.html">
                                <img src="assets/common/images/logo-white.png" alt="main-logo" width="140">
                            </a>
                        </div>
                    ...
                    <div class="header-right-content d-flex align-items-center">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <div class="dropdown-wrap" data-simplebar>
                                    <a href="chat.html" class="dropdown-item d-flex">
                                        <div class="icon">
                                            <img src="assets/common/images/sample.png" alt="user-1">
                                        </div>

                                        <div class="content">
                                            <span class="d-block">Umar Dewu</span>
                                    ...
                                    <a href="chat.html" class="dropdown-item d-flex">
                                        <div class="icon">
                                            <img src="assets/common/images/sample.png" alt="user-2">
                                        </div>

                                        <div class="content">
                                            <span class="d-block">Kabiru Alhassan</span>
                                            <!--                                                    <p class="m-0">Lorem ipsum dolor sit, amet consectetur</p>-->
                                    ...
                                    <a href="chat.html" class="dropdown-item d-flex">
                                        <div class="icon">
                                            <img src="assets/common/images/sample.png" alt="user-3">
                                        </div>

                                        <div class="content">
                                            <span class="d-block">Haruna Muhammad</span>
                                            <!--                                                    <p class="m-0">Lorem ipsum dolor sit, amet consectetur</p>-->
                                    ...
                                    <a href="chat.html" class="dropdown-item d-flex">
                                        <div class="icon">
                                            <img src="assets/common/images/sample.png" alt="user-4">
                                        </div>

                                        <div class="content">
                                            <span class="d-block">Ayuba Hambali</span>
                                            <!--                                                    <p class="m-0">Lorem ipsum dolor sit, amet consectetur</p>-->
                        ...
                        <div class="header-right-option dropdown profile-nav-item pt-0 pb-0">
                            <a class="dropdown-item dropdown-toggle avatar d-flex align-items-center" href="#" id="navbarDropdown-4" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                <img src="assets/common/images/user.jpeg" alt="avatar" height="30" style="height:50px !important">
                                <div class="d-none d-lg-block d-md-block">
                                    <h3>Abba Yakubu Abdullahi</h3>
                            ...
                            <div class="dropdown-menu">
                                <div class="dropdown-header d-flex flex-column align-items-center">
                                    <div class="figure mb-3">
                                        <img src="assets/common/images/user.jpeg" class="rounded-circle" alt="avatar" style="height:50px !important">
                                    </div>

                                    <div class="info text-center">
                                        <span class="name">Abba Yakubu Abdullahi</span>
                                        <p class="mb-3 email">
                                            <a href="/cdn-cgi/l/email-protection#cda7a2a5a3bea0a4a1aaac8da5a8a1a1a2e3aea2a0"><span class="__cf_email__" data-cfemail="97fdf8fff9e4fafefbf0f6d7fff2fbfbf8b9f4f8fa">[email&#160;protected]</span></a>
                                        </p>
                                    </div>
                                </div>
    ...
    <nav class="side-menu-area style-two">
        <nav class="sidebar-nav" data-simplebar>
            <ul id="sidebar-menu" class="sidebar-menu">
                ...
                <li>
                    <a href="{{ route('farmer.index') }}" class="box-style d-flex align-items-center">
                        <div class="icon">
                ...
                <li>
                    <a href="{{ route('agro-dealer.index') }}" class="box-style d-flex align-items-center">
                        <div class="icon">
                            <img src="assets/images/icon/profile-2user.svg" alt="profile-2user">
                        </div>
                        <span class="menu-title">Agro-Dealers</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="#" class="box-style d-flex align-items-center">
                        ...
                        <span class="menu-title">Strategic Plans</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="#" class="box-style d-flex align-items-center">
                        ...
                        <span class="menu-title">Research Data</span>
                    </a>
                </li>
                ...
                <li>
                    <a href="#" class="box-style d-flex align-items-center">
                        ...
                        <span class="menu-title">Practices</span>
                    </a>
                </li>
            </ul>
        </nav>
        ...
        <div class="footer-area">
            <div class="container-fluid">
                <div class="footer-content">
                    <p>© KASPA is designed and built by Verdant Agri-Tech for the Katsina State Government, Nigeria.</p>
                </div>
            </div>
        </div>
        <!-- End Footer Area -->
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">Input Distribution Form</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body px-5">
                <div class="pb-24">'
                    <div class="mb-3">
                        <label for="formGroupExampleInput" class="form-label">Select Farmer</label>
                        <select type="text" class="form-control" id="formGroupExampleInput" placeholder="Example input placeholder">
                            <option>-- select --</option>
                            <option>Tanimu Hayatu</option>
                            <option>Salisu Shuaibu</option>
                            <option>Sunusi Mohd Inuwa</option>
                            <option>Musa Ahmad</option>
                        </select>
                    </div>
                </div>
                <div class="pb-24">
                    <div class="row">
                        <div class="col">
                            <label for="formGroupExampleInput2" class="form-label">Input</label>
                            <select type="text" class="form-control" aria-label="">
                                <option>-- select --</option>
                                <option>NPK 20:10:10</option>
                                <option>NPK 20:20:20</option>
                            </select>
                        </div>
                        <div class="col">
                            <label for="formGroupExampleInput2" class="form-label">Quantity</label>
                            <input type="number" class="form-control" placeholder="Quantity" aria-label="">
                        </div>
                    </div>
                </div>
                <div class="pb-24">'
                    <div class="mb-3">
                        <label for="formGroupExampleInput2" class="form-label">Subsidy Band</label>
                        <select class="form-control" placeholder="Subsidy Amount" aria-label="">
                            <option>-- select --</option>
                ...
                <div class="pb-24">
                    <div class="mb-3">
                        <label for="formGroupExampleInput" class="form-label">Select Agro Dealer</label>
                        <select type="text" class="form-control" id="agro-dealer" >
                            <option>-- select --</option>
                            <option>CropVille Fertilisers Ltd</option>
                            <option>Garden Growers Nig Ltd</option>
                            <option>Gardener'S Choice Fertilizers</option>
                            <option>Growfast Fertilizers Company Ltd.</option>
                        </select>
                    </div>
                </div>
...
<div class="modal fade" id="information" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="informationLabel">About KASPA</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <div class="modal-body px-5">
                <p>The Katsina Sustainable Platform for Agriculture (KASPA) is an all-round initiative of the  Katsina State Government, aimed at connecting the state’s agricultural value chains and using digital technologies to help farmers improve yields and access markets.</p>
            </div>
